 ...
 *   <li>AWS SQS scheduled polling for consuming order events</li>
 *   <li>Spring Boot Actuator for health checks and monitoring</li>
 * </ul>
 *
 * <p>The service consumes Kafka/SQS events from the Order Service to:
 * <ul>
 *   <li>Update inventory when orders are created</li>
 *   <li>React to order status changes</li>
 * </ul>
 *
 * <p>The service runs on port 8082 by default.
 *
...
public class ProductServiceApplication {
     ...
     * <p>Prerequisites:
     * <ul>
     *   <li>Kafka must be running if Kafka consumers are enabled</li>
     *   <li>AWS credentials and SQS queue URL must be configured if SQS consumer is enabled</li>
     * </ul>
     *
